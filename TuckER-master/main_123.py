...
class Experiment:
    ...
    def __init__(self, learning_rate=0.0005, ent_vec_dim=200, sdim=10, adim=10, odim=10, 
    ...
    def retrain(self, num_it, path="rkbrary/ift6760-exp/a1b2c3d", model_state='model_state.pts'):
        ...
        model = TuckER(d, self.ent_vec_dim, self.sdim, self.adim, self.odim, **self.kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--sdim", type=int, default=10, nargs="?",
                    help="Symmetric relation embedding dimensionality.")
    parser.add_argument("--adim", type=int, default=10, nargs="?",
                    help="Asymmetric relation embedding dimensionality.")
    parser.add_argument("--odim", type=int, default=10, nargs="?",
                    help="Other relations embedding dimensionality.")
    ...
    config.sdim = args.sdim
    config.adim = args.adim
    config.odim = args.odim
    ...
    experiment = Experiment(num_iterations=args.num_iterations, batch_size=args.batch_size, learning_rate=args.lr, 
                            decay_rate=args.dr, ent_vec_dim=args.edim, sdim=args.sdim, adim=args.adim, odim=args.odim, 
